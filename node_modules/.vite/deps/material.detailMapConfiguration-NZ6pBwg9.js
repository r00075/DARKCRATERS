...
import { i as serialize, m as serializeAsTexture, n as expandToProperty, v as __decorate } from "./decorators-CatBgmln.js";
import { t as SerializationHelper } from "./decorators.serialization-DDf03RoE.js";
import { F as ProcessIncludes } from "./tools.functions-BjbqYpqF.js";
import { t as ShaderStore } from "./shaderStore-CoAr55uN.js";
import { t as Material } from "./material-W2EEA90o.js";
import { B as MaterialFlags, O as PrepareDefinesForMergedUV, d as BindTextureMatrix } from "./materialHelper.functions-DvxPR--c.js";
import { c as MaterialDefines } from "./imageProcessing-B-xleE-L.js";
			...
			case 8: {
				...
				for (const plugin of this._plugins) {
					...
					if (uniforms) {
						if (uniforms.ubo) for (const uniform of uniforms.ubo) {
							if (uniform.size && uniform.type) {
								...
								if (isWebGPU) {
									...
									if (arraySize > 0) this._uboDeclaration += `uniform ${uniform.name}: array<${type}, ${arraySize}>;\n`;
						...
						if (uniforms.externalUniforms) this._uniformList.push(...uniforms.externalUniforms);
					}
			...
			for (let pointName in points) {
				...
				for (const plugin of this._activePlugins) {
					...
					if (plugin.resolveIncludes) {
						if (processorOptions === null) processorOptions = {
							defines: [],
...
//#endregion
export { RegisterMaterialPlugin as a, MaterialPluginManager as i, MaterialDetailMapDefines as n, UnregisterAllMaterialPlugins as o, MaterialPluginBase as r, UnregisterMaterialPlugin as s, DetailMapConfiguration as t };

//# sourceMappingURL=material.detailMapConfiguration-NZ6pBwg9.js.map