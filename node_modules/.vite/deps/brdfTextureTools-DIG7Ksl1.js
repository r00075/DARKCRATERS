...
var loadBRDFTexture = (scene, textureData, textureProperty, textureName) => {
	if (!scene[textureProperty]) {
		...
		if (index !== -1) texturesCache.splice(index, 1);
		texture.isRGBD = true;
...
//#endregion
export { GetOpenPBREnvironmentBRDFTexture as i, GetEnvironmentBRDFTexture as n, GetEnvironmentFuzzBRDFTexture as r, BRDFTextureTools as t };

//# sourceMappingURL=brdfTextureTools-DIG7Ksl1.js.map