...
import { a as Vector3, i as Vector2, n as Quaternion, t as Matrix } from "./math.vector-DQTwgFRW.js";
import { n as Color4 } from "./math.color-pmCH9CVK.js";
import { t as Animation } from "./animation-DHidjZo0.js";
import { t as SpotLight } from "./spotLight-C8uL5-t-.js";
import { t as Constants } from "./constants-BRDYyaBW.js";
...
*/
var OptionalPathExceptionsList = [{ regex: new RegExp(`^/nodes/\\d+/extensions/`) }];
/**
		...
		for (const part of parts) {
			...
			if (!ignoreObjectTree) {
				if (objectTree === void 0) {
					if (!OptionalPathExceptionsList.find((e) => e.regex.test(path))) throw new Error(`Path ${path} is invalid`);
				} else if (!isLength) objectTree = objectTree?.[part];
			}
	...
	__array__: {
		...
		extensions: {
			...
			KHR_node_visibility: { visible: {
				...
				getTarget: () => void 0,
				set: (value, node) => {
					if (node._primitiveBabylonMeshes) node._primitiveBabylonMeshes.forEach((mesh) => mesh.isVisible = value);
				}
			} }
		}
	}
...
var materialsTree = { __array__: {
	...
	emissiveTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("emissiveTexture") } },
	normalTexture: {
		scale: {
			type: "number",
		...
		extensions: { KHR_texture_transform: GenerateTextureMap("bumpTexture") }
	},
	occlusionTexture: {
		strength: {
			type: "number",
		...
		extensions: { KHR_texture_transform: GenerateTextureMap("ambientTexture") }
	},
	pbrMetallicRoughness: {
		...
		baseColorTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("albedoTexture") } },
		metallicFactor: {
			type: "number",
		...
		metallicRoughnessTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("metallicTexture") } }
	},
	extensions: {
		KHR_materials_anisotropy: {
			...
			anisotropyTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("anisotropy", "texture") } }
		},
		KHR_materials_clearcoat: {
			...
			clearcoatTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("clearCoat", "texture") } },
			clearcoatNormalTexture: {
				...
				extensions: { KHR_texture_transform: GenerateTextureMap("clearCoat", "bumpTexture") }
			},
			clearcoatRoughnessTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("clearCoat", "textureRoughness") } }
		},
		...
		KHR_materials_iridescence: {
			...
			iridescenceTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("iridescence", "texture") } },
			...
			iridescenceThicknessTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("iridescence", "thicknessTexture") } }
		},
		KHR_materials_sheen: {
			sheenColorFactor: {
				type: "Color3",
			...
			sheenColorTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("sheen", "texture") } },
			...
			sheenRoughnessTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("sheen", "thicknessTexture") } }
		},
		KHR_materials_specular: {
			...
			specularTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("metallicReflectanceTexture") } },
			specularColorTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("reflectanceTexture") } }
		},
		KHR_materials_transmission: {
			...
			transmissionTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("subSurface", "refractionIntensityTexture") } }
		},
		KHR_materials_diffuse_transmission: {
			...
			diffuseTransmissionTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("subSurface", "translucencyIntensityTexture") } },
			...
			diffuseTransmissionColorTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("subSurface", "translucencyColorTexture") } }
		},
		KHR_materials_volume: {
			...
			thicknessTexture: { extensions: { KHR_texture_transform: GenerateTextureMap("subSurface", "thicknessTexture") } }
		}
	}
} };
var extensionsTree = {
...
var glTFLoaderAnimation_exports = /* @__PURE__ */ __exportAll({
...
//#endregion
export { getVector3 as a, AddObjectAccessorToKey as c, SetInterpolationForKey as d, getQuaternion as i, GetMappingForKey as l, TransformNodeAnimationPropertyInfo as n, getWeights as o, WeightAnimationPropertyInfo as r, glTFLoaderAnimation_exports as s, AnimationPropertyInfo as t, GetPathToObjectConverter as u };

//# sourceMappingURL=glTFLoaderAnimation-C2LHtvFR.js.map