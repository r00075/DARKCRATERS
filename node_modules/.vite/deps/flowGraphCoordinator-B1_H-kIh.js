...
import { i as serialize, v as __decorate } from "./decorators-CatBgmln.js";
import { n as RandomGUID } from "./guid-DL_mXGAj.js";
import { t as PointerEventTypes } from "./pointerEvents-DaiUnmjO.js";
import { t as KeyboardEventTypes } from "./keyboardEvents-C5Z7nI2_.js";
import { o as defaultValueSerializationFunction } from "./flowGraphBlock-BWpYsKc5.js";
import { n as GetFlowGraphAssetWithType } from "./flowGraphAssetsContext-Bs7mbCDJ.js";
import { t as FlowGraphExecutionBlock } from "./flowGraphExecutionBlock-MpOf-UAt.js";
import { t as FlowGraphAsyncExecutionBlock } from "./flowGraphAsyncExecutionBlock-xmRMKxSf.js";
import { a as _IsDescendantOf, o as _IsMacPlatform } from "./utils-DurkAuPB.js";
...
*/
var FlowGraphSceneEventCoordinator = class FlowGraphSceneEventCoordinator {
	constructor(scene) {
		/**
	...
	_initialize() {
		...
		this._keyDownObserver = this._scene.onKeyboardObservable.add((keyboardInfo) => {
			...
			if (FlowGraphSceneEventCoordinator._COMMAND_OR_CTRL_CODES.has(code)) this.pressedKeys.add("CommandOrControl");
			this.onEventTriggeredObservable.notifyObservers({
				type: "KeyDown",
		...
		this._keyUpObserver = this._scene.onKeyboardObservable.add((keyboardInfo) => {
			...
			if (FlowGraphSceneEventCoordinator._COMMAND_OR_CTRL_CODES.has(code)) {
				let stillHeld = false;
				for (const c of Array.from(FlowGraphSceneEventCoordinator._COMMAND_OR_CTRL_CODES)) if (c !== code && this.pressedKeys.has(c)) {
					stillHeld = true;
					break;
				}
				if (!stillHeld) this.pressedKeys.delete("CommandOrControl");
			}
			this.onEventTriggeredObservable.notifyObservers({
				type: "KeyUp",
				payload: keyboardInfo
	...
	dispose() {
		...
		if (this._onBlurHandler) {
			this._scene.getEngine().getRenderingCanvas()?.removeEventListener("blur", this._onBlurHandler);
			this._onBlurHandler = null;
		}
...
//#endregion
export { ValidateFlowGraph as a, FlowGraphAction as c, FlowGraphValidationSeverity as i, FlowGraphLogger as l, FlowGraph as n, ValidateFlowGraphWithBlockList as o, FlowGraphState as r, FlowGraphContext as s, FlowGraphCoordinator as t };

//# sourceMappingURL=flowGraphCoordinator-B1_H-kIh.js.map