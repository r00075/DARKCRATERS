...
import { a as Vector3 } from "./math.vector-DQTwgFRW.js";
import { t as Color3 } from "./math.color-pmCH9CVK.js";
...
var pbrMaterialLoadingAdapter_exports = /* @__PURE__ */ __exportAll({ PBRMaterialLoadingAdapter: () => PBRMaterialLoadingAdapter });
/**
...
var PBRMaterialLoadingAdapter = class {
	...
	*/
	set baseDiffuseRoughness(value) {
		...
		if (value > 0) this._material.brdf.baseDiffuseModel = Constants.MATERIAL_DIFFUSE_MODEL_E_OREN_NAYAR;
	}
	/**
	...
	*/
	set specularColor(value) {
		if (this._specWorkflow) this._material.reflectivityColor = value;
		else this._material.metallicReflectanceColor = value;
	}
	/**
	...
	*/
	get specularColor() {
		if (this._specWorkflow) return this._material.reflectivityColor;
		else return this._material.metallicReflectanceColor;
	}
	/**
	...
	*/
	set specularColorTexture(value) {
		if (this._specWorkflow) {
			...
			if (this._material.reflectivityTexture) this._material.reflectivityTexture.hasAlpha = true;
		} else this._material.reflectanceTexture = value;
	}
	/**
	...
	*/
	get specularColorTexture() {
		if (this._specWorkflow) return this._material.reflectivityTexture;
		else return this._material.reflectanceTexture;
	}
	/**
	...
	*/
	set specularRoughnessTexture(value) {
		if (!this.baseMetalnessTexture) this._material.metallicTexture = value;
	}
	/**
	...
	*/
	set ambientOcclusionTexture(value) {
		...
		if (value) this._material.useAmbientInGrayScale = true;
	}
	/**
	...
	*/
	set transmissionDepth(value) {
		if (this.transmissionWeight > 0) this._material.subSurface.tintColorAtDistance = value;
		else if (this.subsurfaceWeight > 0) this._material.subSurface.diffusionDistance.multiplyInPlace(new Color3(value, value, value));
	}
	/**
	...
	*/
	get transmissionDepth() {
		if (this.transmissionWeight > 0) return this._material.subSurface.tintColorAtDistance;
		return 0;
	}
	/**
	...
	*/
	set transmissionColor(value) {
		if (this.transmissionWeight > 0) this._material.subSurface.tintColor = value;
		else if (this.subsurfaceWeight > 0) this._material.subSurface.diffusionDistance.multiplyInPlace(value);
	}
	/**
	* Sets the attenuation color (mapped to PBR subSurface.tintColor).
	...
	*/
	get transmissionColor() {
		if (this.transmissionWeight > 0) return this._material.subSurface.tintColor;
		else if (this.subsurfaceWeight > 0) return this._material.subSurface.diffusionDistance;
	...
	*/
	set volumeThickness(value) {
		...
		if (value > 0) this._material.subSurface.volumeIndexOfRefraction = this._material.indexOfRefraction;
	}
	/**
	...
	*/
	set subsurfaceColor(value) {
		...
		extinctionCoefficient.scaleInPlace(1 / Math.max(this.transmissionDepth, .001));
	...
	*/
	set fuzzWeightTexture(value) {
		if (!this._material.sheen.texture) this._material.sheen.texture = value;
	}
	/**
	...
	*/
	set geometryCoatNormalTextureScale(value) {
		if (this._material.clearCoat.bumpTexture) this._material.clearCoat.bumpTexture.level = value;
	}
};
//#endregion
export { pbrMaterialLoadingAdapter_exports as n, PBRMaterialLoadingAdapter as t };

//# sourceMappingURL=pbrMaterialLoadingAdapter-DUJdPoul.js.map