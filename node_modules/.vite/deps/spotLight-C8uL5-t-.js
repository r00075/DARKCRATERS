import { a as Vector3, r as TmpVectors, t as Matrix } from "./math.vector-DQTwgFRW.js";
...
import { g as serializeAsVector3, i as serialize, m as serializeAsTexture, n as expandToProperty, o as serializeAsColor3, v as __decorate } from "./decorators-CatBgmln.js";
import { t as SerializationHelper } from "./decorators.serialization-DDf03RoE.js";
import { t as Node } from "./node-CtoN8jw8.js";
import { t as UniformBuffer } from "./uniformBuffer-BQNFLzL_.js";
import { t as LightConstants } from "./lightConstants-BE9WLn6V.js";
import { t as Axis } from "./math.axis-ToXyenSs.js";
...
*/
var Light = class Light extends Node {
	/**
	...
	*/
	_getPhotometricScale() {
		...
		if (photometricMode === Light.INTENSITYMODE_AUTOMATIC) if (lightTypeID === Light.LIGHTTYPEID_DIRECTIONALLIGHT) photometricMode = Light.INTENSITYMODE_ILLUMINANCE;
		else photometricMode = Light.INTENSITYMODE_LUMINOUSINTENSITY;
		switch (lightTypeID) {
...
var SpotLight = class SpotLight extends ShadowLight {
	...
	*/
	...
	/** @override */
	areLightTexturesReady() {
		if (this._projectionTexture && !this._projectionTexture.isReadyOrNotBlocking()) return false;
		if (this._iesProfileTexture && !this._iesProfileTexture.isReadyOrNotBlocking()) return false;
		return true;
	}
	/**
...
//#endregion
export { ShadowLight as n, Light as r, SpotLight as t };

//# sourceMappingURL=spotLight-C8uL5-t-.js.map