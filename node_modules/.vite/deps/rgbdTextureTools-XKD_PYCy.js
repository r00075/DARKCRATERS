import { f as PostProcess, t as ApplyPostProcess } from "./textureTools-CISLl-30.js";
...
var RGBDTextureTools = class {
	...
	*/
	static ExpandRGBDTexture(texture) {
		...
		const expandRgbdTextureAsync = async () => {
			...
			internalTexture.isReady = false;
			if (isWebGpu) await import("./rgbdDecode.fragment-CSEoCMvR.js").then((n) => n.n);
	...
	*/
	static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
		if (!scene.getEngine().isWebGPU) await import("./rgbdEncode.fragment-D49DnYgV.js").then((n) => n.n);
		else await import("./rgbdEncode.fragment-DsFQ18eF.js").then((n) => n.n);
...
//# sourceMappingURL=rgbdTextureTools-XKD_PYCy.js.map