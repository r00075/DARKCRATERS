...
import { b as RichTypeString, d as RichTypeBoolean, t as FlowGraphBlock } from "./flowGraphBlock-BWpYsKc5.js";
//#region node_modules/@babylonjs/core/FlowGraph/Blocks/Data/flowGraphIsKeyPressedBlock.js
var flowGraphIsKeyPressedBlock_exports = /* @__PURE__ */ __exportAll({ FlowGraphIsKeyPressedBlock: () => FlowGraphIsKeyPressedBlock });
/**
...
var FlowGraphIsKeyPressedBlock = class extends FlowGraphBlock {
	...
	*/
	...
	_updateOutputs(context) {
		...
		if (pressed && this.withShift.getValue(context)) pressed = keys.has("ShiftLeft") || keys.has("ShiftRight");
		if (pressed && this.withCtrl.getValue(context)) pressed = keys.has("ControlLeft") || keys.has("ControlRight");
		if (pressed && this.withAlt.getValue(context)) pressed = keys.has("AltLeft") || keys.has("AltRight");
		if (pressed && this.withMeta.getValue(context)) pressed = keys.has("MetaLeft") || keys.has("MetaRight");
		if (pressed && this.withCommandOrCtrl.getValue(context)) pressed = keys.has("CommandOrControl");
...
//#endregion
export { flowGraphIsKeyPressedBlock_exports as n, FlowGraphIsKeyPressedBlock as t };

//# sourceMappingURL=flowGraphIsKeyPressedBlock-vF8Tl_Fq.js.map