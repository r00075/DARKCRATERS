...
const spawnDefinitions: EnemySpawnDefinition[] = [
  ...
  {
    id: "ridge-outer-route-patrol",
    poiId: "data-shack",
    encounterType: "light-patrol",
    type: "grunt",
    role: "rusher",
    spawn: new Vector3(-112, 0, 88),
    patrolPoints: [new Vector3(-112, 0, 88), new Vector3(-92, 0, 68), new Vector3(-122, 0, 58)],
    minDifficultyLevel: 2,
    optional: true,
  },
  {
    id: "drop-yard-route-patrol",
    poiId: "warehouse",
    encounterType: "light-patrol",
    type: "grunt",
    role: "rusher",
    spawn: new Vector3(-58, 0, -48),
    patrolPoints: [new Vector3(-58, 0, -48), new Vector3(-78, 0, -36), new Vector3(-38, 0, -28)],
    minDifficultyLevel: 2,
    optional: true,
  },
  {
    id: "alien-growth-spitter-watch",
    poiId: "core-pit",
    encounterType: "objective-defense",
    type: "spitter",
    role: "support",
    spawn: new Vector3(108, 0, 78),
    patrolPoints: [new Vector3(108, 0, 78), new Vector3(122, 0, 88), new Vector3(96, 0, 68)],
    minDifficultyLevel: 3,
    optional: true,
    highValueLoot: true,
  },
  {
    id: "alien-growth-horror-pressure",
    poiId: "core-pit",
    encounterType: "elite-guard",
    type: "elite",
    role: "flanker",
    spawn: new Vector3(118, 0, 84),
    patrolPoints: [new Vector3(118, 0, 84), new Vector3(102, 0, 74), new Vector3(126, 0, 62)],
    minDifficultyLevel: 5,
    optional: true,
    highValueLoot: true,
  },
