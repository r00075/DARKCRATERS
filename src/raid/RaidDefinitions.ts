...
export const raidDefinitions: RaidDefinition[] = [
  {
    ...
    lengthSeconds: 8 * 60,
    difficultyLabel: "Low",
    enemyDensityLabel: "Low Umbra presence",
    ...
    description: "Recently opened zones with light Umbra activity and basic salvage.",
    accentColor: "#2F8CFF",
  ...
  },
  {
    ...
    enemyDensityLabel: "Moderate Umbra pressure",
  ...
  },
  {
    ...
    enemyDensityLabel: "Strong Umbra presence",
  ...
  },
  {
    ...
    enemyDensityLabel: "Heavy Umbra encounters",
  ...
  },
  {
    ...
    enemyDensityLabel: "Extreme Umbra + boss chance",
