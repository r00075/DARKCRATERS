...
export const itemDefinitions: Record<LootType, ItemDefinition> = {
  ...
  "weapon-parts": {
    ...
    use: "Used for weapon repair and future upgrades.",
    useProfile: {
      roles: ["craft", "repair", "upgrade"],
      usableInRaid: false,
      usableInHQ: true,
  ...
  "weapon-repair-kit": {
    ...
    use: "Used to restore weapon condition where supported.",
    useProfile: {
      roles: ["repair"],
      usableInRaid: false,
      usableInHQ: true,
      currentUse: "Used to restore weapon condition where supported.",
