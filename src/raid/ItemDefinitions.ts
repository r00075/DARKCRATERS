...
export const itemDefinitions: Record<LootType, ItemDefinition> = {
  ...
  "scanner-battery": {
    ...
    slots: 1,
    value: 3,
    description: "Tuned utility power source for reveal scanners and Lumen field devices.",
    use: "Powers reveal scanner recipes and future Lumen field tools.",
    useProfile: {
      roles: ["craft", "reveal", "future"],
      usableInRaid: false,
      usableInHQ: true,
      currentUse: "Utility power source for reveal scanners and Lumen field devices.",
  ...
  "essence-flare": {
    ...
    use: "Emits a short-range Lumen reveal pulse.",
    useProfile: {
      roles: ["consume", "reveal"],
      usableInRaid: true,
      usableInHQ: false,
      currentUse: "Emits a short-range Lumen reveal pulse. Reveals nearby Lumen signatures for 10s.",
