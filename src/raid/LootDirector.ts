...
export class LootDirector {
  ...
  public constructor(private readonly scene: Scene) {
    ...
    this.lootMaterials = {
      ...
      "scanner-battery": this.createLootMaterial("loot-scanner-battery-material", "scanner-battery"),
      ...
      "essence-flare": this.createLootMaterial("loot-essence-flare-material", "essence-flare"),
