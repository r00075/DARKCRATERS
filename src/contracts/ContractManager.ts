...
const contractPool: readonly ContractDefinition[] = [
  ...
  },
  {
    ...
    description: "The Quiet Order detected a Lumen pulse beneath Mare Vanta. Investigate without triggering a full alert.",
    ...
    reward: {
      ...
      rareCoreChance: 0.16,
      recipeUnlock: "Lumen Signal Scanner",
      tier: "elite",
      contractPoints: 4,
      reputationTokens: 1,
    },
  ...
  },
  {
    ...
    description: "Destroy alien Choir Nodes before they black out the HUD and pull the Lumen into the lava tubes.",
    difficulty: "hard",
    targetPoi: "The Hollow Sea",
    risk: "Critical",
    requiresExtraction: true,
