...
export const evidenceContractVariants: readonly EvidenceContractDefinition[] = [
  ...
  },
  {
    ...
    type: "poi-objective",
    title: "Resonance Survey Sweep",
    description: "Classify luminescent material as geological interference before field crews infer structure.",
    factionId: "lea",
    zoneId: "mare-vanta",
    recommendedTier: "Survey Run",
    difficulty: "medium",
    ...
    evidenceVariant: {
      ...
      optionalEvidenceIds: ["scanner-battery-archive", "structured-residue-pattern"],
      unavailableReason: "Lumen Residue Sample not logged.",
      corporateCopy: "Classify residue as geological interference.",
      hiddenCopy: "Residue reacts to repeated routes like biological memory.",
      rewardFlavor: "Survey payout with scanner material chance.",
      codexHook: "Structured Residue Pattern",
  ...
  },
  {
    ...
    type: "poi-objective",
    title: "Memory Residue Trial",
    description: "Repeat scanner sweep near known residue clusters and archive any response pattern.",
  ...
  },
  {
    ...
    evidenceVariant: {
      ...
      optionalEvidenceIds: ["resonance-pattern-fragment", "historical-signal-match", "blc1-warning-fragment"],
      unavailableReason: "Signal Fragment not logged.",
      corporateCopy: "Archive signal noise without crew speculation.",
      hiddenCopy: "Cadence repeats outside relay timing; older radio records begin to rhyme.",
      rewardFlavor: "Signal archive payout with broker reputation.",
      codexHook: "Resonance Pattern Fragment",
  ...
  },
  {
    ...
    evidenceVariant: {
      ...
      optionalEvidenceIds: ["sealed-cache-manifest", "apollo-residue-anomaly"],
      ...
      hiddenCopy: "Black box timestamps do not match official crater telemetry; one trace predates the mining operation.",
      rewardFlavor: "Evidence custody payout and broker reputation.",
      codexHook: "Apollo Residue Anomaly",
  ...
  },
  {
    ...
    description: "Investigate Surface Form response without triggering full alert.",
    factionId: "quietOrder",
    zoneId: "mare-vanta",
    recommendedTier: "Blackout Zone",
    difficulty: "hard",
    ...
    evidenceVariant: {
      ...
      operationAffinity: ["regolith-trace", "company-silence"],
      requiredEvidenceIds: [],
      optionalEvidenceIds: ["crew-memory-report", "mare-vanta-signal-fragment", "lumen-residue-sample", "impact-fracture-signal", "lcross-targeting-discrepancy"],
      ...
      codexHook: "Impact Fracture Signal",
