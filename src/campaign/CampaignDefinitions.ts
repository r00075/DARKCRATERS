...
export const campaignActs: readonly CampaignActDefinition[] = [
  {
    ...
    hiddenTruthFraming: "Lumen residue is increasing below the regolith, but corporate reports classify biological memory as relay noise.",
    ...
    nextActTeaser: "Signal Contamination unlocks when field evidence, Memory Matter, and sealed reports stop matching company files.",
  },
  {
    id: "act-2",
    ...
    hiddenTruthFraming: "The crater network is answering back through terrain-borne resonance; old radio records may not be coincidence.",
  ...
  },
  {
    ...
    hiddenTruthFraming: "Lumen Surface Form movement can be hidden, preserved, or betrayed.",
  ...
  },
  {
    ...
    hiddenTruthFraming: "Humanity is no longer uncontested inside the Moon's memory network.",
...
export const campaignOperations: readonly CampaignOperationDefinition[] = [
  {
    ...
    corporateObjective: "Recover company-tagged crates, incident records, and pre-mining liability files.",
    hiddenTruthHint: "Black box timestamps may not match official crater telemetry or legacy program contamination notes.",
  ...
  },
  {
    ...
    hiddenTruthHint: "Cargo exposure disturbs a resonance layer the company files as equipment strain.",
  ...
  },
  {
    ...
    hiddenTruthHint: "Relay noise contains impossible biological cadence and historical signal correlations.",
  ...
  },
  {
    ...
    hiddenTruthHint: "Recovered luminous material suggests Memory Matter: biological storage, intent, and communication.",
  ...
  },
  {
    ...
    hiddenTruthHint: "Corporate language is beginning to contradict recovered data, sealed impact records, and warning fragments.",
