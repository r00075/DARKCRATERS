...
const timePresets: Record<TimeOfDayPreset, EnvironmentVisualPreset> = {
  morning: {
    sky: new Color3(0.045, 0.064, 0.102),
    light: new Color3(0.7, 0.82, 0.98),
    ground: new Color3(0.072, 0.09, 0.122),
    intensity: 0.78,
    sunIntensity: 0.78,
    sunDirection: new Vector3(-0.35, -0.82, 0.28),
    fogColor: new Color3(0.058, 0.082, 0.118),
    fogDensity: 0.005,
  },
  afternoon: {
    sky: new Color3(0.032, 0.046, 0.076),
    light: new Color3(0.66, 0.8, 1),
    ground: new Color3(0.054, 0.068, 0.088),
    intensity: 0.74,
    sunIntensity: 0.82,
    sunDirection: new Vector3(-0.2, -0.95, 0.12),
    fogColor: new Color3(0.038, 0.052, 0.078),
    fogDensity: 0.004,
  },
  dusk: {
    sky: new Color3(0.026, 0.027, 0.066),
    light: new Color3(0.52, 0.58, 0.9),
    ground: new Color3(0.045, 0.048, 0.078),
    intensity: 0.56,
    sunIntensity: 0.54,
    sunDirection: new Vector3(-0.55, -0.35, 0.34),
    fogColor: new Color3(0.038, 0.036, 0.086),
    fogDensity: 0.011,
  },
  night: {
    sky: new Color3(0.008, 0.012, 0.022),
    light: new Color3(0.24, 0.46, 0.82),
    ground: new Color3(0.022, 0.032, 0.052),
    intensity: 0.46,
    sunIntensity: 0.32,
    sunDirection: new Vector3(0.32, -0.48, -0.18),
    fogColor: new Color3(0.014, 0.022, 0.042),
    fogDensity: 0.012,
  },
};
